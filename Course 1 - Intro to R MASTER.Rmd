...
We have been working with single values, which are vectors of 1. To illustrate the different classes we are going to create some vectors which we will then join together later
to make a dataframe.
